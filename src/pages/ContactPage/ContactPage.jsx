      ...
      <div className={`${styles.paddingY} `}>
        <div className="container mx-auto pt-16">
          <div className="lg:flex mb-10">
            <div className="xl:w-2/5 lg:w-2/5 bg-red-950 py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
              <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
                ...
                <p className="text-base text-white pb-8 leading-relaxed font-normal lg:pr-4">
                  Tem alguma pergunta sobre nós? Você está interessado em fazer
                  parceria conosco? Tem alguma sugestão ou apenas quer dizer oi?
                  Basta entrar em contato conosco. Estamos aqui para
                  patrimoniá-lo.
                </p>
                <div className="flex pb-4 items-center">
                  ...
                  <p className="pl-4 text-white text-base">+244 948 880 797</p>
                </div>
