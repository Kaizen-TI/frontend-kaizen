  ...
  return (
    <div className={`${styles.paddingX} ${styles.flexCenter}`}>
      <div className={`${styles.boxWidth}`}>
        <section className=" bg-primary pt-20 lg:pt-[120px] pb-12 lg:pb-[90px] relative z-20 overflow-hidden">
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-4">
               ...
               "
                >
                  ...
                  "
                  >
                    Perfeito para usar em seu negócio ou projeto.
                  </p>
                  <div className="mb-7">
                    <div className="flex ">
                      <svg
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Gestão e Gerenciamento Completo de até 2 redes sociais
                      </p>
                    </div>
                    <div className="flex ">
                      <svg
                    ...
                    <div className="flex ">
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Até 3 posts (artes) por semana em cada rede social 
                      </p>
                    </div>
                    <div className="flex ">
                      <svg
                    ...
                    <div className="flex ">
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Planejamento e cronograma mensal, SEO
                      </p>
                    </div>
                    <div className="flex ">
                    <svg
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-4">
               ...
               "
                >
                  ...
                  "
                  >
                    Excelente para empresas que desejam maximizar seu impacto
                    nas redes sociais.
                  </p>
                  <div className="mb-7">
                    <div className="flex ">
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Gestão e Gerenciamento Completo de até 3 redes sociais
                      </p>
                    </div>
                    <div className="flex ">
                      <svg
                    ...
                    <div className="flex ">
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Até 7 posts (artes) por semana em cada rede social (
                        Sábado e Domingo)
                      </p>
                    </div>
                    <div className="flex ">
              ...
              <div className="w-full md:w-1/2 lg:w-1/3 px-4">
               ...
               "
                >
                  ...
                  "
                  >
                    Ideal para negócio que buscam uma presença de marca sólida e
                    engajadora.
                  </p>
                  <div className="mb-7">
                    <div className="flex ">
                    ...
                    <div className="flex ">
                      ...
                      <p className="text-base text-body-color leading-loose mb-1">
                        Até 5 posts (artes) por semana em cada rede social 
                      </p>
                    </div>
                    <div className="flex ">
                      <svg
