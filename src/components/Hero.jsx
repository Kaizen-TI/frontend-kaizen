...
const Hero = () => {
  return (
        ...
        <section
          id="home"
          className={`flex mt-20 md:flex-row flex-col ${styles.paddingY}`}
        >
          <div
          ...
          >
            <div className="flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
              <p className={`${styles.paragraph} ml-2`}>
                Faça crescer <span className="text-white">75% </span>o seu
                negócio <span className="text-white">em poucos meses</span>
              </p>
            </div>
            ...
            <p className={`${styles.paragraph2} text-red-950  max-w-[470px] mt-5`}>
